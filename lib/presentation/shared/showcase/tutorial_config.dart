...
class TutorialConfig {
  ...
  static const bool disableBarrierInteraction = true; // Permite clicar nos widgets
  static const bool disableDefaultTargetGestures = false; // Mantém gestos do widget
  static const Duration autoAdvanceDelay = Duration(seconds: 8); // Avança automaticamente se não interagir
  ...
  static const String step4Description =
      'Use a barra inferior para trocar de categoria. Você também pode deslizar a tela para a esquerda ou direita.';
